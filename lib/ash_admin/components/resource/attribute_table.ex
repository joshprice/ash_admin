      ...
      <table class="table-auto w-full">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-2 py-3 text-left text-sm font-semibold text-gray-900"><HeroIcon name={if attribute.primary_key?, do: "check", else: "x"} class="h-4 w-4 text-gray-500" /></td>
            <td class="px-2 py-3 text-left text-sm font-semibold text-gray-900"><HeroIcon name={if attribute.private?, do: "check", else: "x"} class="h-4 w-4 text-gray-500" /></td>
            <td class="px-2 py-3 text-left text-sm font-semibold text-gray-900"><HeroIcon name={if attribute.allow_nil?, do: "check", else: "x"} class="h-4 w-4 text-gray-500" /></td>
            <td class="px-2 py-3 text-left text-sm font-semibold text-gray-900"><HeroIcon name={if attribute.writable?, do: "check", else: "x"} class="h-4 w-4 text-gray-500" /></td>
          </tr>
        </tbody>
      </table>
    </div>
